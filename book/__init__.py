...
初始化日志
"""
logging.basicConfig(level=logging.DEBUG)  # 调试debug级(开发环境)
file_log_handler = RotatingFileHandler("{}/logs/books.log".format(os.getcwd()), maxBytes=1024 * 1024 * 100, backupCount=10)  # 100M
